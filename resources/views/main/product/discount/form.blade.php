...
<section class="content">
    ...
    <div class="box {{ CommonHelper::getBoxTheme() }}">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('product_value') ? ' has-error' : '' }}">
                <label for="" class="col-sm-2 control-label">Discount Value (%)</label>
                <div class="col-sm-8">
                    <input type="number" min="0" max="100" step="any" class="form-control" id="product_value" name="product_value" value="{{ CommonHelper::getVal($model, 'product_value') ? CommonHelper::getVal($model, 'product_value') : 0 }}">
                    @if ($errors->has('product_value'))
                        <span class="help-block">
                            <strong>{{ $errors->first('product_value') }}</strong>
                        </span>
                    @endif
                </div>
            </div>
            <div class="form-group {{ $errors->has('date_start') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control input-datepicker" id="date_start" name="date_start" value="{{ CommonHelper::getVal($model, 'date_start') ? CommonHelper::getVal($model, 'date_start') : date('Y-m-d') }}">
            ...
            <div class="form-group {{ $errors->has('date_end') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control input-datepicker" id="date_end" name="date_end" value="{{ CommonHelper::getVal($model, 'date_end') ? CommonHelper::getVal($model, 'date_end') : date('Y-m-d') }}">
