    ...
    <div class="box {{ CommonHelper::getBoxTheme() }}">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('product_value') ? ' has-error' : '' }}">
                <label for="" class="col-sm-2 control-label">Size Value (%)</label>
                <div class="col-sm-8">
                    <input type="number" min="0" step="any" class="form-control" id="product_value" name="product_value" value="{{ CommonHelper::getVal($model, 'product_value') ? CommonHelper::getVal($model, 'product_value') : 0 }}">
